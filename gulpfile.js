...
gulp.task('mongoimport', function () {
    shelljs.exec('mongo awpDB --eval "db.elements.remove({})"');
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene1.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene2.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene3_1.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene3_2.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene3_3.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene3_4.json");
    shelljs.exec("mongoimport --db awpDB --collection elements --file config/mongoimport/ebene3_5.json");
});
